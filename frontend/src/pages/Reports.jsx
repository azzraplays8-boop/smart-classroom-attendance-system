...
function Reports() {
  ...
  const handleExportPDF = async () => {
    ...
    try {
      ...
      doc.text(schoolSettings.schoolName || "School Name", 45, 20);
      ...
      const tableColumns = ["#", "Date", "Student #", "Student Name", "Course / Strand", "Year Level", "Section", "Time In", "Status"];
      ...
      doc.setFontSize(8);
      doc.setFont("helvetica", "italic");
      doc.text("Generated by Smart Classroom Attendance System", 14, finalY + 18);
  ...
  const handleExportExcel = () => {
    ...
    try {
      ...
      const wsData = [
        [`${schoolSettings.schoolName || "School"} — Attendance Report`],
        ...
        [],
        ["Date", "Student Number", "Student Name", "Course / Strand", "Year Level", "Section", "Time In", "Status"],
      ];
    ...
    <div className="reports-page">
      ...
      <div className="reports-filter-card">
        <div className="reports-filters-grid">
          ...
          {/* Row 2 */}
          <div className="filter-item">
            <label className="attendance-history-label" htmlFor="reports-course">Course / Strand</label>
            <select
              id="reports-course"
              value={courseFilter}
